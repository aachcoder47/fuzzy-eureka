...
export default function ProductPage({ productSlug, onNavigate }: ProductPageProps) {
  ...
  const getProductDetails = () => {
    const details: Record<string, { description: string; features: string[]; warning?: string; videoId?: string; subheading: string; trustBadges?: string[] }> = {
      'social-ai': {
        subheading: 'Dominate Social Media',
      ...
      'hire-ai': {
        subheading: 'Build Your Dream Team',
      ...
      'engage-ai': {
        subheading: 'Scale Customer Conversations',
    ...
    return details[productSlug] || { subheading: 'AI-Powered Solution', description: product.description, features: product.features };
  };
